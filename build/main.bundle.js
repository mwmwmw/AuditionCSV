...
var _AuditionCSV = __webpack_require__(2);

var _AuditionCSV2 = _interopRequireDefault(_AuditionCSV);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _AuditionCSV2.default;
...
var AuditionCSV = function () {
    function AuditionCSV() {
        _classCallCheck(this, AuditionCSV);
    }

    _createClass(AuditionCSV, null, [{
        key: 'getMarkers',
        value: function getMarkers(file) {
            return AuditionCSV.load(file).then(function (response) {
                return response.ok ? response.text() : Promise.reject(response);
            }).then(function (results) {
                return AuditionCSV.convert(results);
            }).then(function (results) {
                return results.data;
            });
        }
